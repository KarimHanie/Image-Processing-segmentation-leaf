...
for i in range(267):
    ...
    cv2.imwrite('C:\\Users\\kimok\\Desktop\\saved\\5-Jamun_(P5)\\'+str(i+1)+'.jpg', closing3)
    img2 = cv2.imread('C:\\Users\\kimok\\Desktop\\saved\\5-Jamun_(P5)\\'+str(i+1)+'.jpg', 0)
    img3 = cv2.imread('D:\\1.aast\\1.college\\term8\\Digital image processing\\sec -yousef\\_GroundTruth\\Jamun_(P5)\\image_ ('+str(i+1)+').JPG',0)
    # ==================
